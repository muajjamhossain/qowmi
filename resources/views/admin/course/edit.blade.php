                    ...
                    <div class="col-12">
                      <div class="card">
                          <div class="card-header">
                              <h4 class="card-title"> Edit New Course Here... </h4>
                          ...
                          <form id="jquery-val-form" action="{{ route('course.update',$data->id) }}" method="post"
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group row custom_form_group{{ $errors->has('course_name_en') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-7">
                                <input type="text" placeholder="Enter Course Name English" class="form-control" name="course_name_en" value="{{ $data->course_name_en }}" required>
                            ...
                            <div class="form-group row custom_form_group{{ $errors->has('course_name_bn') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-7">
                                <input type="text" placeholder="Enter Course Name Bangla" class="form-control" name="course_name_bn" value="{{ $data->course_name_bn }}" required>
                            ...
                            <div class="form-group row custom_form_group{{ $errors->has('course_name_arb') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-7">
                                <input type="text" placeholder="Enter Course Name Arabic" class="form-control" name="course_name_arb" value="{{ $data->course_name_arb }}" required>
                            ...
                            <div class="form-group row custom_form_group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-7">
                                <input type="date" placeholder="Enter Start Date" class="form-control" name="start_date" value="{{ $data->start_date }}" required>
                            ...
                            <div class="form-group row custom_form_group{{ $errors->has('end_date') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-7">
                                <input type="date" placeholder="Enter End Date" class="form-control" name="end_date" value="{{ $data->end_date }}" required>
                            ...
                            <div class="form-group row custom_form_group{{ $errors->has('class_time_in') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-7">
                                <input type="text" placeholder="Enter Class In Time" class="form-control" name="class_time_in" value="{{ $data->class_time_in }}" required>
                            ...
                            <div class="form-group row custom_form_group{{ $errors->has('class_time_out') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-7">
                                <input type="text" placeholder="Enter Class Out Time" class="form-control" name="class_time_out" value="{{ $data->class_time_out }}" required>
                            ...
                            <div class="form-group row custom_form_group{{ $errors->has('ragular_price') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-7">
                                <input type="text" placeholder="Enter Regular Price" class="form-control" name="ragular_price" value="{{ $data->ragular_price }}" required>
                            ...
                            <div class="form-group row custom_form_group{{ $errors->has('discount_price') ? ' has-error' : '' }}">
                              ...
                              <div class="col-md-7">
                                <input type="text" placeholder="Enter Discount Price" class="form-control" name="discount_price" value="{{ $data->discount_price }}" required>
                            ...
                            <div class="form-group row custom_form_group">
                              ...
                              <div class="col-md-7">
                                <textarea name="description_en" rows="8" cols="80" class="form-control" placeholder="Enter English Description">{{ $data->description_en }}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="form-group row custom_form_group">
                              ...
                              <div class="col-md-7">
                                <textarea name="description_bn" rows="8" cols="80" class="form-control" placeholder="Enter Bangla Description">{{ $data->description_bn }}</textarea>
                              </div>
                            </div>
                            ...
                            <div class="form-group row custom_form_group">
                              <label class="ccontrol-label col-md-3">{{ __('Decription Bangla:') }}<span class="req_star">*</span></label>
                              <div class="col-md-7">
                                <textarea name="description_arb" rows="8" cols="80" class="form-control" placeholder="Enter Arabic Description">{{ $data->description_arb }}</textarea>
                              </div>
                            </div>
