                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <div class="breadcrumbs__custom">
                              <h2 class="content-header-title float-left mb-0">Teachers Information View</h2>
                              <div class="breadcrumb-wrapper">
                                  <ol class="breadcrumb">
                                      <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a>
                                  </li>
                                  <li class="breadcrumb-item active">Teachers Information View</li>
                              </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                      <div class="card">
                          <div class="card-header">
                              <h4 class="card-title"> View Teachers Here... </h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="form-group custom_form_group{{ $errors->has('name_en') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Name English" class="form-control" id="name_en" name="name_en" value="{{ $data->name_en }}" disabled>
                                  ...
                                  <div class="form-group custom_form_group{{ $errors->has('name_arb') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Name Arabic" class="form-control" id="name_arb" name="name_arb" value="{{ $data->name_arb }}" disabled>
                                  ...
                                  <div class="form-group custom_form_group{{ $errors->has('title_bn') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Title Bangla" class="form-control" id="title_bn" name="title_bn" value="{{ $data->title_bn }}" disabled>
                                  ...
                                  <div class="form-group custom_form_group{{ $errors->has('description_en') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                      <textarea name="description_en" class="form-control" rows="8" cols="80" placeholder="Enter Description English" disabled>{{ $data->description_en }}</textarea>
                                  ...
                                  <div class="form-group custom_form_group{{ $errors->has('description_bn') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                      <textarea name="description_bn" class="form-control" rows="8" cols="80" placeholder="Enter Description Bangla" disabled>{{ $data->description_bn }}</textarea>
                                  ...
                                  <div class="form-group custom_form_group{{ $errors->has('description_arb') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                      <textarea name="description_arb" class="form-control" rows="8" cols="80" placeholder="Enter Description Arabic" disabled>{{ $data->description_arb }}</textarea>
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="form-group custom_form_group{{ $errors->has('name_bn') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Name Bangla" class="form-control" id="name_bn" name="name_bn" value="{{ $data->name_bn }}" disabled>
                                  ...
                                  <div class="form-group custom_form_group{{ $errors->has('title_en') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Title English" class="form-control" id="title_en" name="title_en" value="{{ $data->title_en }}" disabled>
                                  ...
                                  <div class="form-group custom_form_group{{ $errors->has('title_arb') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Title Arabic" class="form-control" id="title_arb" name="title_arb" value="{{ $data->title_arb }}" disabled>
                                  ...
                                  <div class="form-group custom_form_group{{ $errors->has('education1') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Educational" class="form-control" id="education1" name="education1" value="{{ $data->education1 }}" disabled>
                                  ...
                                  <div class="form-group custom_form_group{{ $errors->has('education2') ? ' has-error' : '' }}">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Educational" class="form-control" id="education2" name="education2" value="{{ $data->education2 }}" disabled>
                                  ...
                                  <div class="form-group custom_form_group">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Educational" class="form-control" name="education3" value="{{ $data->education3 }}" disabled>
                                    </div>
                                  </div>
                                  {{-- element --}}
                                  <div class="form-group custom_form_group">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Educational" class="form-control" name="education4" value="{{ $data->education4 }}" disabled>
                                    </div>
                                  </div>
                                  {{-- element --}}
                                  <div class="form-group custom_form_group">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Educational" class="form-control" name="education5" value="{{ $data->education5 }}" disabled>
                                    </div>
                                  </div>
                                  <hr>
                                  {{-- element --}}
                                  <div class="form-group custom_form_group">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Facebook Link" class="form-control" name="sm_1" value="{{ $data->sm_1 }}" disabled>
                                    </div>
                                  </div>
                                  {{-- element --}}
                                  <div class="form-group custom_form_group">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Twitter Link" class="form-control" name="sm_2" value="{{ $data->sm_2 }}" disabled>
                                    </div>
                                  </div>
                                  {{-- element --}}
                                  <div class="form-group custom_form_group">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Linkdien Link" class="form-control" name="sm_3" value="{{ $data->sm_3 }}" disabled>
                                    </div>
                                  </div>
                                  {{-- element --}}
                                  <div class="form-group custom_form_group">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Instagram Link" class="form-control" name="sm_4" value="{{ $data->sm_4 }}" disabled>
                                    </div>
                                  </div>
                                  <hr>
                                  {{-- element --}}
                                  <div class="form-group custom_form_group">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Phone Number" class="form-control" name="phone1" value="{{ $data->phone1 }}" disabled>
                                    </div>
                                  </div>
                                  {{-- element --}}
                                  <div class="form-group custom_form_group">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Phone Number 2" class="form-control" name="phone2" value="{{ $data->phone2 }}" disabled>
                                    </div>
                                  </div>
                                  {{-- element --}}
                                  <div class="form-group custom_form_group">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Email" class="form-control" name="email1" value="{{ $data->email1 }}" disabled>
                                    </div>
                                  </div>
                                  {{-- element --}}
                                  <div class="form-group custom_form_group">
                                    ...
                                    <div>
                                      <input type="text" placeholder="Enter Email 2" class="form-control" name="email2" value="{{ $data->email2 }}" disabled>
                                    </div>
                                  </div>
                                  {{-- *************** --}}
                                </div>
