                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="research-box1">
                            <img src="{{ asset('content/fontend') }}/img/research/1.jpg" class="img-responsive" alt="research">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="research-box1">
                            <img src="{{ asset('content/fontend') }}/img/demo/img5.png" class="img-responsive" alt="research">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="research-box1">
                            <img src="{{ asset('content/fontend') }}/img/research/3.jpg" class="img-responsive" alt="research">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="research-box1">
                            <img src="{{ asset('content/fontend') }}/img/research/4.jpg" class="img-responsive" alt="research">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="research-box1">
                            <img src="{{ asset('content/fontend') }}/img/research/5.jpg" class="img-responsive" alt="research">
