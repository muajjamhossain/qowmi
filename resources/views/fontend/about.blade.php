        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type
                    ...
                    <br>
                    <br> It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages.
                </p>
                <a href="#" class="btn btn-default btn-about">VIEW OUR COURSE</a>
            </div>
            <div class="col-md-5">
                <img src="{{ asset('content/fontend') }}/images/welcome-img.jpg" class="img-fluid" alt="#">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-md-12">
                <div class="single-item">
                    <div class="quote">
                        ...
                        <p class="quote_text">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Printing and typesetting
                            industry. It has survived not only five centuries.</p>
                        <div class="testi-img_block">
                            <img src="{{ asset('content/fontend') }}/images/testi-img.jpg" class="img-fluid" alt="#">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="our-teachers-block">
                    <img src="{{ asset('content/fontend') }}/images/our-teachers_01.jpg" class="img-fluid teachers-img" alt="#">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="our-teachers-block">
                    <img src="{{ asset('content/fontend') }}/images/our-teachers_02.jpg" class="img-fluid teachers-img" alt="#">
                    <div class="teachers-description">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="our-teachers-block">
                    <img src="{{ asset('content/fontend') }}/images/our-teachers_03.jpg" class="img-fluid teachers-img" alt="#">
                    <div class="teachers-description">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="our-teachers-block">
                    <img src="{{ asset('content/fontend') }}/images/our-teachers_04.jpg" class="img-fluid teachers-img" alt="#">
                    <div class="teachers-description">
